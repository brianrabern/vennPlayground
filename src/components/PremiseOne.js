    ...
    <>
      {premise1.show ? (
        <div className="subitem">
          ...
          <p className="px-3 ">
            <strong>Premise 1:</strong> <strong>{evaluationP1}</strong>
          </p>
          <hr></hr>
          <div id="premise1" className="col">
            <svg
              id="premise1cellH"
              style={{ backgroundColor: premise1.fillColors.cellH }}
            ...
            >
              <g id="layer1">
                ...
                <path
                  ...
                  id="premise1cellA"
                  fill={premise1.fillColors.cellA}
                  fillOpacity="1"
                  stroke="#000000"
                  strokeWidth="2"
                />
                <path
                  ...
                  id="premise1cellE"
                  fill={premise1.fillColors.cellE}
                  fillOpacity="1"
                  stroke="#000000"
                  strokeWidth="2"
                />
                <path
                  ...
                  id="premise1cellG"
                  fill={premise1.fillColors.cellG}
                  fillOpacity="1"
                  stroke="#000000"
                  strokeWidth="2"
                />
                <path
                  ...
                  id="premise1cellC"
                  fill={premise1.fillColors.cellC}
                  fillOpacity="1"
                  stroke="#000000"
                  strokeWidth="2"
                />
                <path
                  ...
                  id="premise1cellB"
                  fill={premise1.fillColors.cellB}
                  fillOpacity="1"
                  stroke="#000000"
                  strokeWidth="2"
                />
                <path
                  ...
                  id="premise1cellD"
                  fill={premise1.fillColors.cellD}
                  fillOpacity="1"
                  stroke="#000000"
                  strokeWidth="2"
                />
                <path
                  ...
                  id="premise1cellF"
                  fill={premise1.fillColors.cellF}
                  fillOpacity="1"
                  stroke="#000000"
                  strokeWidth="2"
                />
